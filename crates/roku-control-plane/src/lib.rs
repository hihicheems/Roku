...
//!
//! This crate is the stable home for task/event/approval/result/dispatch
//! persistence semantics. Concrete backends such as SQLite belong to adapter
//! crates and must not redefine the control-plane contract here.
