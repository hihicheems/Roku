...
fn default_profiles() -> Vec<CapabilityProfile> {
	vec![
		...
		CapabilityProfile::new(PROFILE_DATA, vec!["data.".to_string()], 12_000, 35_000),
		CapabilityProfile::new(
			PROFILE_REVIEW,
		...
		CapabilityProfile::new(PROFILE_SKILL, vec!["skill.".to_string()], 10_000, 120_000),
		CapabilityProfile::new(PROFILE_GENERAL, Vec::new(), 8_000, 20_000),
	]
}
